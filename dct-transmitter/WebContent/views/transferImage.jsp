...
<th>Decrypt Image And show Secret Text</th>
<!-- <th>Secret Text</th> -->
  ...
  <tr ng-repeat="x in productList">
    ...
    <td>{{x.name}}</td>
     ...
     <td><button ng-click="showText(x.compressionText)">Decrypt Image And show Secret Text</button></td>
<!-- <td>{{x.compressionText}}</td> -->
